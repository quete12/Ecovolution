 ...
 * triplePointTemperature </ul> The Idea of Case2 is to implement following
 * connections:
 * <ul>
 ...
 * <li> melting triplePoint to infinity (pressure and temperature limited by 0)
...
public class PhaseDiagramCase2 extends PhaseDiagram {
    ...
    public PhaseDiagramCase2(CompoundProperties properties)
    {
        super(properties, "Case 2");
    }
