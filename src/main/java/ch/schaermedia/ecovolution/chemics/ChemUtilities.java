...
public class ChemUtilities {
    ...
    public static void moles(BigDouble pressure_kPa, BigDouble volume_L, BigDouble temperature_K, BigDouble amount_mol)
    {
        ...
        BigDouble b = GAS_CONSTANT_L_kPa_K.mul(temperature_K, new BigDouble());
        a.div(b, amount_mol);
        if (amount_mol.isNegative())
        {
            System.out.println("a=" + pressure_kPa + " * " + volume_L + ", b=" + GAS_CONSTANT_L_kPa_K + " * " + temperature_K);
    ...
    public static void pressure_kPa(BigDouble volume_L, BigDouble amount_mol, BigDouble temperature_K, BigDouble pressure_kPa)
    {
        ...
        amount_mol.mul(GAS_CONSTANT_L_kPa_K, pressure_kPa).mul(temperature_K).div(volume_L);
    }
    ...
    public static BigDouble temperature_K(BigDouble pressure_kPa, BigDouble volume_L, BigDouble amount_mol)
    {
        ...
        return pressure_kPa.mul(volume_L, new BigDouble()).div(amount_mol.mul(GAS_CONSTANT_L_kPa_K, new BigDouble()));
    }
    ...
    {
        return tempInK.sub(CELSIUS_TO_KELVIN_CONVERSION, new BigDouble());
    }
    //</editor-fold>
    ...
    {
        return tempInC.add(CELSIUS_TO_KELVIN_CONVERSION, new BigDouble());
    }
    ...
    public static void volume_L(BigDouble pressure_kPa, BigDouble amount_mol, BigDouble temperature_K, BigDouble volume_L)
    {
        ...
        amount_mol.mul(GAS_CONSTANT_L_kPa_K, volume_L).mul(temperature_K).div(pressure_kPa);
    }
